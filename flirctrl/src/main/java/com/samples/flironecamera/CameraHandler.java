...
class CameraHandler {
    ...
    // Add YoonImage to use in YoonFactory
    private YoonImage imageProcessor;
    ...
    private synchronized void withImage(ThermalImageStreamListener listener, Camera.Consumer<ThermalImage> functionToRun) {
        if (camera == null) {
            return;
        }
    ...
    private final Camera.Consumer<ThermalImage> handleIncomingImage = new Camera.Consumer<ThermalImage>() {
        ...
        public void accept(ThermalImage thermalImage) {
            ...
            imageProcessor = new YoonImage(dcBitmap);
